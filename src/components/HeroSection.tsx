        ...
        >
          <div className="flex flex-col items-end gap-0.5">
            <a
              ...
              className="flex items-center gap-1.5 text-[11px] font-medium tracking-[0.14em] uppercase text-white/60 hover:text-[#3B82F6] transition-all duration-300 ease-in-out"
            >
              <Phone className="w-3 h-3" strokeWidth={1.5} />
              +387 66 057 780
            </a>
            <a
              href="tel:+38765449068"
              className="flex items-center gap-1.5 text-[11px] font-medium tracking-[0.14em] uppercase text-white/60 hover:text-[#3B82F6] transition-all duration-300 ease-in-out"
            >
              <Phone className="w-3 h-3" strokeWidth={1.5} />
              +387 65 449 068
    ...
    <LazyMotion features={domMax} strict>
      <section className="relative w-full min-h-screen flex flex-col overflow-hidden bg-[#0B0C0E]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          {/* Gradient overlays removed to make video fully clear and remove black tint */}
        </div>
